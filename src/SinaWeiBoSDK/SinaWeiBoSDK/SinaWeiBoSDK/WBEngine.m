...
- (void)logIn
{
   ...
   //  NSLog(@"rootViewController===%@",[rootViewController debugDescription]);
    if(![rootViewController isKindOfClass:[MyAccountViewController class]]){//防止在其它页面弹出
        return;
    }
