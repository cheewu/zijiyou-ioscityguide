...
//
//        disclosure addTarget:self action:<#(SEL)#> forControlEvents:<#(UIControlEvents)#>
////        UITapGestureRecognizer *singleTapRecognizer = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(disclosureTapped)];
////         singleTapRecognizer.cancelsTouchesInView = NO;
////        [self addGestureRecognizer:singleTapRecognizer];
////        [singleTapRecognizer setDelegate:self];
////       
//        
//        self.rightAccessoryView = disclosure;
