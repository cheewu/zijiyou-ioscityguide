...
//    [hmacSha1Request prepare];
    ...
    WBRequest *hmacSha1Request = [WBRequest requestWithURL:TWITTERRequestURL dic:[NSDictionary dictionaryWithObjectsAndKeys:@"oauth://zijiyou.com",@"oauth_callback",nil] method:@"GET" withServers:@"twitter" requestToken:YES accessToken:NO];
